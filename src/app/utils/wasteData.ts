...
export const WASTE_CATEGORIES: Record<string, WasteCategory> = {
  ...
  textile: {
    ...
    binColor: "Reciklažno dvorište",
    binColorHex: "#EC4899",
    icon: "🏭",
    explanation: "Ovakav otpad (poput velikih predmeta, građevinskog materijala, elektronike, guma, ili tekstila) obavezno odnesite u reciklažno dvorište.",
    examples: ["Odjeća i tekstil", "Elektronika (E-otpad)", "Građevinski otpad", "Drvo ili željezo"],
  },
  bio: {
    id: "bio",
    name: "Bio otpad",
...
export const WASTE_CATEGORIES_EN: Record<string, WasteCategory> = {
  ...
  textile: {
    ...
    binColor: "Recycling Center (Reciklažno dvorište)",
    binColorHex: "#EC4899",
    icon: "🏭",
    explanation: "Such waste (e.g. large items, construction materials, electronics, tires, or textiles) must be taken to a recycling yard.",
    examples: ["Clothing & textiles", "Electronics", "Construction waste", "Wood & metal"],
  },
  bio: {
    id: "bio",
    name: "Organic waste",
